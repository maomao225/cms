...
define([
	...
	var view = Backbone.View.extend({
		...
		events: {
			...
			'click .send-btn': 'validateContent',
		...
		initUpload: function(){
			...
			$('#fileupload').fileupload({
				...
				add: function(e, data){
					...
					var list = data.result.recipient;
					view.$el.find("input[name='recipient']").val(list.join(";"));
		...
		validateContent: function(){
			var recipient = this.$el.find("input[name='recipient']").val();
		...
		saveEvent: function(){
            var outlink = this.$el.find(".q-form [name='outlink']").val();
