...
define([
	...
	var view = Backbone.View.extend({
		...
		refreshList: function() {
			var view = this;
			var formValues = $(".posts-view .q-form").serialize() + "&recordsPerPage=" + view.pageInfo.recordsPerPage + "&page=" + view.pageInfo.page;
		...
		popupPost: function(e){
			...
			$.ajax({
				loader: true,
				url: '../static/js/src/data/posts-detail.json',
				data: {
					postId: postId
				},
				dataType: "json",
