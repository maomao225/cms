...
define([
	...
	var view = Backbone.View.extend({
		...
		refreshList: function() {
			var view = this;
			var formValues = $(".comments-view .q-form").serialize() + "&recordsPerPage=" + view.pageInfo.recordsPerPage + "&page=" + view.pageInfo.page;
			var param = qStrToJson(formValues);
			$.ajax({
				loader: true,
				url: '../static/js/src/data/comments-list.json',
				data: param,
				dataType: "json",
		...
		startQuery: function(){
			var postId = this.$el.find("input[name='postId']").val();
			var commentId = this.$el.find("input[name='commentId']").val();
		...
		confirmDelete: function(e){
			$("#delete-modal").attr("data-comment-id", $(e.currentTarget).attr("data-comment-id"));
