...
define([
	...
	'underscore',
	'bootstrap',
	'text!src/tpl/homepage/recommend.tpl',
	'text!src/tpl/homepage/recommend-list.tpl',
	'text!src/tpl/homepage/recommend-detail.tpl',
	'text!src/tpl/homepage/preview-recommend.tpl',
	'src/util',
	'fileupload',
	...
	var view = Backbone.View.extend({
		...
		startQuery: function(){
			...
			$.ajax({
				loader: true,
				url: '../static/js/src/data/recommend-list.json',
				dataType: "json",
		...
		confirmDelete: function(e){
			$("#delete-modal").find(".confirm-delete-btn").data("recommend-id", $(e.currentTarget).data("recommend-id"));
			$("#delete-modal").modal("show");
		},
		deleteRecommend: function(e){
			var view = this;
			var target = $(e.currentTarget);
			var recommendId = target.data("recommend-id");
			$.ajax({
				loader: true,
				url: '../static/js/src/data/recommend-list.json',
				data: {
		...
		previewModule: function(){
			...
			$.ajax({
				loader: true,
				url: '../static/js/src/data/preview-recommend.json',
				dataType: "json",
				success: function (data, status) {
					if (data.statusCode) {
						panel.html(tpl(data));
		...
		editRecommend: function(e){
			var recommendId = $(e.currentTarget).data("recommend-id");
			var modal = $("#edit-modal");
			var view = this;
			$.ajax({
				loader: true,
				url: '../static/js/src/data/recommend-detail.json',
				data: {
					id: recommendId
				},
				dataType: "json",
		...
		validateDetail: function(form){
			...
			var recommendid = form.find("input[name='cid']").val();
		...
		renderResults: function(data) {
			this.$el.find(".h-recommend-view .list-content").html(this.listTemplate(data));
		}
	});
	return view;
});