<form class="form-horizontal detail-form">
	...
	<div class="form-group">
		<label class="col-xs-3 control-label"><span class="required-text">*&nbsp;</span>课程描述：</label>
		<div class="col-xs-9">
	...
	<div class="form-group">
		<label class="col-xs-3 control-label">角标图片：</label>
		<div class="col-xs-7">
			<input type="text" class="form-control fileinput" name="ref_url" value="<%= (typeof ref_url == 'undefined') ? '' : ref_url %>"/>
		</div>
		<div class="col-xs-2">
			<button type="button" class="btn btn-default fileinput-button">
				<span>一键上传</span>
