<div class="letters-view">
	<form class="form-horizontal q-form">
		<div class="form-group">
			...
			<div class="col-xs-2">
				<input type="text" class="form-control input-sm" name="recipient" placeholder="例：123456">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-2">
				<input type="text" class="form-control input-sm" name="sender" placeholder="例：学堂在线">
			</div>
