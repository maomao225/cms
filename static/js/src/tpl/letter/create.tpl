<div class="create-letter">
	<form class="form-horizontal q-form">
		<div class="form-group">
			...
			<div class="col-xs-5">
				<input type="text" class="form-control input-sm" name="recipient">
			</div>
			<div class="col-xs-2">
		...
		<div class="form-group">
			...
			<div class="col-xs-2">
				<input type="text" class="form-control input-sm need-count" name="linklabel" maxlength="4">
			</div>
			<div class="col-xs-5">
		...
		<div class="form-group inline-desc">
			...
			<div class="col-xs-5">
				<input type="text" class="form-control input-sm" name="linkaddress">
			</div>
		</div>
		<div class="form-group">
