<div class="logo-view">
	<form class="form-horizontal q-form">
		<div class="form-group">
			...
			<div class="col-xs-4">
				<input type="text" class="form-control input-sm" name="name" placeholder="请输入Logo名称">
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-xs-9">
				<div class="radio-inline">
					<label>
						<input type="radio" class="q-radio" name="order_type" value="name" checked>Logo首字母升序排列
					</label>
				</div>
				<div class="radio-inline">
					<label>
						<input type="radio" class="q-radio" name="order_type" value="-name">Logo首字母降序排列
					</label>
				</div>
				<div class="radio-inline">
					<label>
	...
	<table class="table table-bordered table-xt">
		<thead>
			<tr>
				<th style="width: 15%;">Logo名称</th>
				<th style="width: 10%;">Logo图片格式</th>
				<th style="width: 20%;">电子证书Logo图片</th>
				<th style="width: 20%;">纸质证书Logo图片</th>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">Logo图片预览</h4>
				</div>
	...
	<div class="modal fade edit-modal" id="create-modal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title">新增Logo</h4>
				</div>
				<div class="modal-body">
	...
	<div class="modal fade confirm-modal" id="delete-modal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-sm">
			<div class="modal-content">
				...
				<div class="modal-body">
					<p class="confirm-desc">您确定要删除该Logo？（删除后将无法恢复）</p>
					<div class="row">
