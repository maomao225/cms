<div class="posts-view">
	<form class="form-horizontal q-form">
		<div class="form-group">
			...
			<div class="col-xs-2">
				<input type="text" class="form-control input-sm" name="author" placeholder="例：学堂在线">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-2">
				<select class="form-control input-sm" name="hideType">
			...
			<div class="col-xs-4">
				<input type="text" class="form-control input-sm" name="keywords" placeholder="请输入 帖子标题 关键词（多个以空格分开）...">
			</div>
		</div>
		<div class="form-group">
