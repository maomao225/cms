<div class="f-comments-view">
	<form class="form-horizontal q-form">
		<div class="form-group">
			<div class="inline-desc">帖子ID：</div>
			<div class="col-xs-2">
				<input type="text" class="form-control input-sm" name="topic_id" placeholder="例：123456">
			</div>
		...
		<div class="form-group">
			...
			<div class="col-xs-4">
				<input type="text" class="form-control input-sm" name="keyword" placeholder="请输入 帖子标题/评论 关键词（多个以空格分开）...">
			</div>
		</div>
		<div class="form-group">
			<div class="inline-desc">用户昵称：</div>
			<div class="col-xs-2">
				<input type="text" class="form-control input-sm" name="nickname" placeholder="例：张三">
			</div>
			<div class="inline-desc">片区：</div>
			<div class="col-xs-2">
				<select class="form-control input-sm" name="plate_id">
